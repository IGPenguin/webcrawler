  ...
  <div id="menu_origin_screen" style="display:none;">
    <div class="card menu-main-card" style="background-color:#202020; padding-top:10px; padding-bottom:14px; margin-top:42px">
      ...
      <div style="display:flex; gap:6px;">
        <button class="menu-btn" id="menu_origin_reroll" style="flex:1; font-size:18px; color:#2cc176; background-color:rgb(40 57 79);"><b style="font-size:14px; color:#7193bf;"> 1 🪙</b> Meditate</button>
        <button class="menu-btn" id="menu_origin_combine" style="flex:1; font-size:18px; color:#FFD940; background-color:rgb(40 57 79);"><b style="font-size:14px; color:#7193bf;"> 2 🪙</b> Transmute</button>
      </div>
      <div class="menu-spacer"></div>
  ...
  <div id="menu_credits_screen" style="display:none;">
    <div class="card menu-main-card" style="background-color:#202020; padding-top:10px; padding-bottom:14px; margin-top:42px">
      ...
      <div id="menu_credits_body" style="padding:12px 0 12px 0; box-shadow:inset 0px 0px 0px 3px #000; background-color:#272727;">
        ...
        <h4 style="min-height:0; margin-bottom:10px; padding:0 4px; font-size:14px; color:yellow; font-weight:600;margin-bottom:16px;"><a href="https://github.com/lukaspirkl" target="_blank" rel="noopener">lukaspirkl</a>, [you can be here]</h4>
