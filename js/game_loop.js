...
function playerCheckLevelUp(){
  ...
  if (playerXP>=playerXPThreshold){
    curtainFadeInAndOut("<p style=\"color:"+colorGold+";-webkit-text-stroke: 6.5px black;paint-order: stroke fill;\">Level Increased</p><br>"+decorateStatusText("","Perk point available.",colorWhite));
