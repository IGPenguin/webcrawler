...
function generateNextEncounters(generatorID=0, logCall=true){
  switch (generatorID) {
    ...
    case 30: //House Mid - 20% item
      ...
      var possibleEncounters=["Recruit","Standard","Swift","Heavy","Demon","Spirit","Curse","Trap","Trap-Attack","Trap-Roll","Trap-Sleep","Altar"];
